...
public class V14DParamConfigReq : V14DFrame
{
    ...
    /// <summary>BMS 单体动力蓄电池最高允许充电电压</summary>
    public ushort BmsMaxCellVoltage { get; set; }

    /// <summary>BMS 最高允许充电电流</summary>
    ...
    public V14DParamConfigReq(byte[] body)
    {
        ...
        o += 2;
        BmsMaxChargeCurrent = BitConverter.ToUInt16(body, o);
        o += 2;
        BmsNominalEnergy = BitConverter.ToUInt16(body, o);
        o += 2;
        BmsMaxChargeVoltage = BitConverter.ToUInt16(body, o);
        o += 2;
        BmsMaxTemp = body[o++];
        BmsSoc = BitConverter.ToUInt16(body, o);
        o += 2;
        BmsCurrentVoltage = BitConverter.ToUInt16(body, o);
        o += 2;
        PileMaxOutputVoltage = BitConverter.ToUInt16(body, o);
        o += 2;
        PileMinOutputVoltage = BitConverter.ToUInt16(body, o);
        o += 2;
        PileMaxOutputCurrent = BitConverter.ToUInt16(body, o);
        o += 2;
    ...
    public override byte[] GetBodyBytes()
    {
        ...
        o += 2;
        BitConverter.GetBytes(BmsMaxChargeCurrent).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(BmsNominalEnergy).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(BmsMaxChargeVoltage).CopyTo(b, o);
        o += 2;
        b[o++] = BmsMaxTemp;
        BitConverter.GetBytes(BmsSoc).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(BmsCurrentVoltage).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(PileMaxOutputVoltage).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(PileMinOutputVoltage).CopyTo(b, o);
        o += 2;
        BitConverter.GetBytes(PileMaxOutputCurrent).CopyTo(b, o);
        o += 2;
